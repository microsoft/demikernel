...
fn os_build() -> Result<()> {
    ...
    let bindings: Bindings = builder
        ...
        .allowlist_function("rte_hash_crc")
        .allowlist_function("rte_hash_create")
        .allowlist_function("rte_hash_add_key_data")
        .allowlist_function("rte_hash_add_key_with_hash_data")
        .allowlist_function("rte_hash_lookup_data")
        .allowlist_function("rte_hash_lookup_with_hash_data")
        .clang_arg("-mavx")
        .header("wrapper.h")
