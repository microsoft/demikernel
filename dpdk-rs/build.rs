...
fn os_build() -> Result<()> {
    ...
    let bindings: Bindings = builder
        ...
        .allowlist_var("RTE_ETH_MQ_RX_RSS")
        .allowlist_var("RTE_ETH_MQ_TX_NONE")
        .allowlist_var("RING_F_SP_ENQ")
        .allowlist_var("RING_F_MP_RTS_ENQ")
        .allowlist_var("RING_F_MP_HTS_ENQ")
        .allowlist_var("RING_F_SC_DEQ")
        .allowlist_var("RING_F_MC_RTS_DEQ")
        .allowlist_var("RING_F_MC_HTS_DEQ")
        .allowlist_var("RING_F_EXACT_SZ")
        .allowlist_function("rte_eth_find_next_owned_by")
        .allowlist_function("rte_eth_dev_info_get")
        .allowlist_function("rte_eth_macaddr_get")
        .allowlist_function("rte_auxiliary_register")
        ...
        .allowlist_function("rte_spinlock_init")
        .allowlist_function("rte_spinlock_lock")
        .allowlist_function("rte_spinlock_trylock")
        .allowlist_function("rte_spinlock_unlock")
        .allowlist_function("rte_ring_create")
        .allowlist_function("rte_ring_enqueue")
        .allowlist_function("rte_ring_dequeue")
