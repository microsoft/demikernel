...
extern "C" {
    ...
    fn rte_hash_crc_(data: *const c_void, data_len: u32, init_val: u32) -> u32;
}
...
#[inline]
pub unsafe fn rte_hash_crc(data: *const c_void, data_len: u32, init_val: u32) -> u32 {
    rte_hash_crc_(data, data_len, init_val)
}
