...
DMTR_EXPORT int dmtr_open(int qd, const char *pathname, int flags);
DMTR_EXPORT int dmtr_open2(int qd, const char *pathname, int flags, mode_t mode);
DMTR_EXPORT int dmtr_creat(const char *pathname, mode_t mode);
