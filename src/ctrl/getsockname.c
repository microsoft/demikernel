...
/**
 * @brief Invokes demi_getsockname(), if the socket descriptor is managed by Demikernel.
 *
 ...
 */
int __demi_getsockname(int sockfd, struct sockaddr *addr, socklen_t *addrlen)
{
    int ret = -1;
