...
int dmtr_init(int argc, char *argv[])
{
    ...
    ioq_api->register_queue_ctor(dmtr::io_queue::NETWORK_Q, dmtr::spdk_dpdk_queue::new_net_object);
    ioq_api->register_queue_ctor(dmtr::io_queue::FILE_Q, dmtr::spdk_dpdk_queue::new_file_object);
    return 0;
}
