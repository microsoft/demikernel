...
int dmtr_init(int argc, char *argv[])
{
    ...
    DMTR_OK(dmtr::spdk_rdma_queue::init_spdk_rdma(argc, argv));
    ...
    ioq_api->register_queue_ctor(dmtr::io_queue::NETWORK_Q, dmtr::spdk_rdma_queue::new_net_object);
    ioq_api->register_queue_ctor(dmtr::io_queue::FILE_Q, dmtr::spdk_rdma_queue::new_file_object);
    return 0;
}
