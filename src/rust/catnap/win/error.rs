...
/// Translate a WSA_ERROR into an errno. Most WSA errors have direct equivalence. If the error is not catalogued
...
/// Translate a WSA_ERROR into a windows crate Error type.
...
/// Convert from WSA_ERROR to Fail.
