...
impl Config {
    ...
    pub fn send_buffer_size(&self) -> Result<usize, Fail> {
        Self::require_int_option(self.get_libos_section()?, "send_buffer_size")
    }

    /// Reads the "send_buffer_count" parameter from the underlying configuration file.
    pub fn send_buffer_count(&self) -> Result<usize, Fail> {
        Self::require_int_option(self.get_libos_section()?, "send_buffer_count")
    }

    /// Reads the "recv_buffer_size" parameter from the underlying configuration file.
    pub fn recv_buffer_size(&self) -> Result<usize, Fail> {
        Self::require_int_option(self.get_libos_section()?, "recv_buffer_size")
    }

    /// Reads the "recv_buffer_count" parameter from the underlying configuration file.
    pub fn recv_buffer_count(&self) -> Result<usize, Fail> {
        Self::require_int_option(self.get_libos_section()?, "recv_buffer_count")
    }

    /// Reads the "share_send_recv_bufs" parameter from the underlying configuration file.
    pub fn share_send_recv_bufs(&self) -> Result<bool, Fail> {
        Self::require_bool_option(self.get_libos_section()?, "share_send_recv_bufs")
    }
