...
ExternalProject_Add(mtcp_dpdk
  ...
  BUILD_COMMAND make -C ${MTCP_DPDK_SOURCE_DIR} T=${DPDK_TARGET} DESTDIR=${MTCP_DPDK_INSTALL_DIR} EXTRA_CFLAGS=${MTCP_DPDK_EXTRA_CFLAGS} V=1
  INSTALL_COMMAND make -C ${MTCP_DPDK_SOURCE_DIR} install T=${DPDK_TARGET} DESTDIR=${MTCP_DPDK_INSTALL_DIR} EXTRA_CFLAGS=${MTCP_DPDK_EXTRA_CFLAGS} V=1
)
