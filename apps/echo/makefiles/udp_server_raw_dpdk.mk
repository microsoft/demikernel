...
all:
	${CC} -o udp_server dpdk_udp_echo_server.cpp dpdk_common.cpp ../libos/common/latency.cc ../libos/common/message.cc ../libos/common/time_resolution.cc ${FINAL_CFLAGS} ${CFLAGS_CXX} ${FINAL_LDFLAGS} ${FINAL_LIBS}